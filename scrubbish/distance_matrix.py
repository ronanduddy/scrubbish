...
class DistanceMatrix:
    def __init__(self, origin):
        ...
        self.city_hall = (
            "Belfast City Hall, Search Results Donegall Square N, Belfast BT1 5GS"
        )
        self.boulder_world = (
            "Boulder World, Unit 1 Boucher Business Centre, Apollo Rd, Belfast BT12 6HP"
        )
    ...
    def to_h(cls, distance_matrix):
        ...
        for mode in distance_matrix:
            ...
            result[f"to_boulder_world_{mode}_distance"] = boulder_world["distance"][
                "text"
            ]
            result[f"to_boulder_world_{mode}_duration"] = boulder_world["duration"][
                "text"
            ]
