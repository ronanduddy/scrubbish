...
class TestDistanceMatrix(unittest.TestCase):
    def test_to_h(self):
        distance_matrix = {
            "driving": {
                ...
                "origin_addresses": ["x Portallo St, Belfast BT6 9BE, UK"],
                "rows": [
                    {
                        "elements": [
                            {
                                "distance": {"text": "1.7 mi", "value": 2739},
                                "duration": {"text": "8 mins", "value": 494},
                                "status": "OK",
                            },
                            {
                                "distance": {"text": "4.9 mi", "value": 7833},
                ...
                "rows": [
                    {
                        "elements": [
                            {
                                "distance": {"text": "1.7 mi", "value": 2664},
                                "duration": {"text": "9 mins", "value": 550},
                                "status": "OK",
                            },
                            {
                                "distance": {"text": "3.8 mi", "value": 6118},
                                "duration": {"text": "23 mins", "value": 1376},
                                "status": "OK",
                            },
                        ]
                    }
    ...
    def test_get_as_dry_run(self):
        ...
        expected = {"bicycling": {"dry": "run"}, "driving": {"dry": "run"}}
    ...
    def test_get(self, request):
        ...
        expected = {"bicycling": {"foo": "bar"}, "driving": {"foo": "bar"}}
